Feature: Cuenta simple de Minibank
    ...
    Scenario: Crear una nueva cuenta y realizar transacciones
        When creo una cuenta nueva para "USD"
        Then deposito a la cuenta "100.00" "USD"
        And la cuenta debe tener balance de "100.00" "USD"
        Then deposito a la cuenta "100.00" "USD"
        And la cuenta debe tener balance de "200.00" "USD"
        Then retiro de la cuenta "50" "USD"
        And la cuenta debe tener balance de "150.00" "USD"
